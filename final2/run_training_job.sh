...
echo "Improvements over final/:"
echo "  - LiT: DINOv3 FROZEN, text encoder adapts to DINOv3 space"
echo "  - MLP projection: 768 -> 768 -> 512 (was linear 768 -> 512)"
echo "  - Gradient accumulation: 4 steps (effective batch = 256)"
echo "  - LR warmup: linear ramp over 500 steps"
